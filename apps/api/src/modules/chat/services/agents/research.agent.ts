...
// 		async (input) => {
// 			try {
// 				const { knowledgeService, db } = ioc.resolve([
// 					injectKnowledgeService,
// 					injectDatabase,
// 				]);

// 				const results = await knowledgeService.getAll(db, {
...
// 				documentId: z
// 					.string()
// 					.describe("ID of the knowledge document to retrieve"),
// 				includeContent: z
// 					.boolean()
// 					.default(true)
...
// 					.array(z.string())
// 					.optional()
// 					.describe("New tags for the document"),
// 			}),
// 		},
// 	),
// ];
