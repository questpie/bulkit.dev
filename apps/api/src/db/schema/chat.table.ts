...
export const chatConversationsTable = pgTable(
	"chat_conversations",
	{
		...
		pinnedResources: jsonb("pinned_resources")
			.$type<SmartReference[]>()
			.default([])
			.notNull(), // Pinned posts/tasks/etc
...
export const chatMessagesTable = pgTable(
	"chat_messages",
	{
		...
		references: jsonb("references")
			.$type<SmartReference[]>()
			.default([])
			.notNull(), // Referenced posts/tasks/media
...
export const chatMessageReactionsTable = pgTable(
	...
	(table) => [
		uniqueIndex().on(table.messageId, table.userId, table.reactionType),
	],
);
...
export const chatMessageReactionsRelations = relations(
