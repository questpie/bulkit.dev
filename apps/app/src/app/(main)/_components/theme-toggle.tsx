...
import { PiCheck, PiSunBold, PiMoonBold } from "react-icons/pi";
			...
			<DropdownMenuTrigger>
				...
				>
					...
					<div className="h-[1.2rem] w-[1.2rem] relative">
						<PiSunBold className="absolute h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
