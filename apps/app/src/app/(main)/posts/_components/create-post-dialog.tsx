...
export function CreatePostDialog({ children }: { children: ReactNode }) {
	...
	const mutation = useMutation({
		mutationFn: async (...args: Parameters<typeof apiClient.posts.post>) => {
			const res = await apiClient.posts.post(...args);
			if (res.error) {
...
export const CreatePostDialogTrigger = ResponsiveDialogTrigger;
