...
export default async function AIImageProvidersPage() {
  const initialProviders = await apiServer.admin['ai-image-providers'].index.get()
    ...
    return (
      <div className='p-6'>
        ...
        <div className='flex flex-col items-center justify-center h-[400px] text-center'>
          ...
          <h3 className='mt-4 text-lg font-medium'>No AI image providers configured</h3>
          <p className='mt-2 text-sm text-muted-foreground max-w-sm'>
            AI image providers enable AI-powered features like image generation. Add your first
