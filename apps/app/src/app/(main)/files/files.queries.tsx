...
export function folderContentsQueryOptions(folderId?: string | null) {
  return queryOptions({
    ...
    queryFn: async () => {
      if (!folderId) {
        // Root folder
        const res = await apiClient.folders.index.get({
...
export function userFolderPermissionQueryOptions(folderId: string) {
  return queryOptions({
    ...
    queryFn: async () => {
      const res = await apiClient.folders({ id: folderId }).permissions.me.get()
      if (res.error) throw res.error
      return res.data
    },
  })
...
export function useCreateFolder() {
  ...
  return useMutation({
    mutationFn: async (data: CreateFolder) => {
      const res = await apiClient.folders.index.post(data)
      if (res.error) throw res.error
      return res.data
    },
...
export function useUpdateFolder() {
  ...
  return useMutation({
    mutationFn: async (params: { folderId: string; data: UpdateFolder }) => {
      const res = await apiClient.folders({ id: params.folderId }).put(params.data)
      if (res.error) throw res.error
      return res.data
    },
...
export function useUpdateItemOrder() {
  ...
  return useMutation({
    mutationFn: async (params: { folderId: string; data: UpdateFolderItemOrder }) => {
      const res = await apiClient.folders({ id: params.folderId }).items.order.put(params.data)
      if (res.error) throw res.error
      return res.data
    },
    onSuccess: (_, variables) => {
