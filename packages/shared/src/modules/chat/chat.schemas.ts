...
import { Nullable, Nullish, StringLiteralEnum } from '@bulkit/shared/schemas/misc'

// Chat message types
export const ChatMessageType = ['user', 'agent', 'system', 'tool_call', 'tool_result'] as const
export const ChatMessageTypeSchema = StringLiteralEnum(ChatMessageType)

// Agent types
// Reference types for mentions and smart references
export const ChatReferenceType = ['post', 'task', 'user', 'media', 'channel', 'label'] as const
export const ChatReferenceTypeSchema = StringLiteralEnum(ChatReferenceType)

// Mention types
export const MentionType = ['user', 'agent'] as const
export const MentionTypeSchema = StringLiteralEnum(MentionType)

// Reaction types
export const ReactionType = ['like', 'dislike', 'helpful', 'not_helpful'] as const
...
export const ToolCallSchema = Type.Object({
  ...
  status: Nullish(StringLiteralEnum(['pending', 'running', 'completed', 'failed'])),
})
...
export type MentionType = Static<typeof MentionTypeSchema>
...
export type ChatConversationWithMessages = Static<typeof ChatConversationWithMessagesSchema>
