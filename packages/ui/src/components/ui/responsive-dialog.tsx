...
const ResponsiveDialog = createResponsiveComponent(
	"ResponsiveDialog",
	Dialog,
	Drawer,
	true,
);
const ResponsiveDialogTrigger: ResponsiveComponent<
...
const ResponsiveDialogContent: ResponsiveComponent<
...
const ResponsiveDialogHeader: ResponsiveComponent<
...
const ResponsiveDialogTitle: ResponsiveComponent<
...
const ResponsiveDialogClose: ResponsiveComponent<
...
const ResponsiveDialogFooter: ResponsiveComponent<
...
const ResponsiveDialogDescription: ResponsiveComponent<
...
export const ResponsiveConfirmDialogTrigger =
	ResponsiveDialogTrigger as typeof ResponsiveDialogTrigger;
