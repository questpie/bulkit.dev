...
const DesktopHeader = forwardRef<HTMLDivElement, ComponentProps<"div">>(
	(props, ref) => {
...
const DesktopFooter = forwardRef<HTMLDivElement, ComponentProps<"div">>(
	(props, ref) => {
		const { className, ...rest } = props;
		return <div ref={ref} className={cn("px-4 py-2", className)} {...rest} />;
	},
...
const DesktopClose = forwardRef<HTMLButtonElement, ComponentProps<"button">>(
	(props, ref) => {
		const { className, ...rest } = props;
		return (
			<button
...
const ResponsiveDropdownMenuTrigger: ResponsiveComponent<
...
const ResponsiveDropdownMenuContent: ResponsiveComponent<
...
const ResponsiveDropdownMenuClose: ResponsiveComponent<
	ComponentProps<typeof DesktopClose>,
...
const MobileDropdownMenuLabel = forwardRef<HTMLDivElement, LabelProps>(
	(props, ref) => {
		const { className, inset, ...rest } = props;
