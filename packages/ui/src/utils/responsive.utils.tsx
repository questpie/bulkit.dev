...
export type ResponsiveProps<
	...
	TCommonProps = ComponentProps<TDesktopComponent> &
		ComponentProps<TMobileComponent>,
...
export type ResponsiveComponent<TDesktopProps, TMobileProps> = React.FC<
	ResponsiveProps<
		React.ComponentType<TDesktopProps>,
		React.ComponentType<TMobileProps>
	>
>;
...
>(
	...
	ComponentProps<TDesktopComponent>,
	ComponentProps<TMobileComponent>
> {
	const Component = (
		isProvider
			? (props: ResponsiveProps<TDesktopComponent, TMobileComponent>) => {
					...
					return (
						<ResponsiveContext.Provider value={isDesktop}>
							{isDesktop ? (
								<DesktopComponent
									{...applyResponsiveProps(props, isDesktop, defaultProps)}
								/>
							) : (
								<MobileComponent
									{...applyResponsiveProps(props, isDesktop, defaultProps)}
